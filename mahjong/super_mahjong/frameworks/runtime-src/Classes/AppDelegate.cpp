...
// manual bindings
#include "manual_bindings/jsb_utils.h"
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("super_mahjong");
#else
        glview = cocos2d::GLViewImpl::createWithRect("super_mahjong", Rect(0,0,960,640));
#endif
...
// manual bindings
    ScriptingCore::getInstance()->addRegisterCallback(register_jsb_utils);
    sc->start();
